...
/*
    ...
    $FileInfo: groups.php - Last Update: 12/30/2011 SVN 781 - Author: cooldude2k $
*/
...
if($_POST['id']==1) {
$query = sql_pre_query("UPDATE \"".$Settings['sqltable']."groups\" SET \"Name\"='%s',\"NamePrefix\"='%s',\"NameSuffix\"='%s',\"CanUseBBags\"='%s',\"FloodControl\"=%i,\"SearchFlood\"=%i WHERE \"id\"=%i", array($_POST['GroupName'],$_POST['NamePrefix'],$_POST['NameSuffix'],$_POST['CanDoHTML'],$_POST['CanUseBBags'],$_POST['FloodControl'],$_POST['SearchFlood'],$_POST['id'])); }
sql_query($query,$SQLStat); } } }  
$doupdate = false;
