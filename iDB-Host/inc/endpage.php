...
/*
    ...
    $FileInfo: endpage.php - Last Update: 12/30/2011 SVN 781 - Author: cooldude2k $
*/
...
$MyFullTimeNow = GMTimeGet($_SESSION['iDBDateFormat'].", ".$_SESSION['iDBTimeFormat'],0,$_SESSION['UserDST']);
