...
$Settings['idburl'] = $URLsTest['scheme']."://".$_POST['unixname'].".".$URLsTest['host'].$URLsTest['path'];
$URLsTest['host'] = $_POST['unixname'].".".$URLsTest['host'];
...
<br />Install Finish <a href="<?php echo $Settings['idburl']; ?>index.php?act=view">Click here</a> to goto board. ^_^</span>
